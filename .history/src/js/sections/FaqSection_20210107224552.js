...
const FAQ_DATA = {
 ...
 – participants receive investigational drugs that would otherwise be unavailable to the general public. There is no charge for any study-related treatment.
Advance understanding – participants are contributing to medical research that may help other people with early Alzheimer’s disease (AD) in the future.
Medical care – participants are provided with information about their health through regular examinations and tests, which may help to uncover undiagnosed medical conditions and monitor diagnosed early Alzheimer’s
      ...
      answer: [
        ...
        {
          p: '<strong>Advance understanding</strong> – you and your study partner are contributing to medical research that may help other people with early Alzheimer’s disease (AD) in the future.'
        },
        {
          p: '<strong>Medical care</strong> – you will be provided with extensive information about your health through regular examinations and tests, which may help to uncover undiagnosed medical conditions and monitor diagnosed early Alzheimer’s.'
        },
        {
          p: 'Be sure to carefully consider and talk with your doctor about the potential benefits and risks of your participation in a clinical study.'
        },
        { p: "<span class='prescreener-button blue-button' style='cursor: pointer;'>SEE IF YOU OR A LOVED ONE PRE-QUALIFIES</span>" }
      ]
    },
    {
      question: 'Are clinical research studies right for me or my loved one?',
      answer: [
        {
          p:
          'Taking part in a clinical research study requires careful thought. Before you and your study partner decide whether to participate, make sure that you understand any potential risks and/or benefits involved – these will be explained to you by the study doctor. There is no guarantee that you will benefit from taking part in this study, and you should never feel obligated to participate in clinical research. You and your study partner have the right to withdraw from the study at any time and for any reason. You will retain the right to the same standard of care you previously received. There will be no charge for any study-related treatment or care.'
        },
        { p: "<span class='prescreener-button blue-button' style='cursor: pointer;'>SEE IF YOU OR A LOVED ONE PRE-QUALIFIES</span>" }
      ]
    },
    {
      ...
      answer: [
        {
          p: 'The study is expected to last up to 120 weeks (approx. 2 years) for individual participants, during which you will be asked to attend the study center for 9 scheduled visits to undergo medical tests and assessments. The study is made up of three phases:'
        },
        {
          p: '<span class="bullet"></span><strong>Part 1: Screening Phase</strong> – up to 16 weeks before the start of Part 2, you will be invited to attend a Screening visit at which the study team will carry out tests to determine your suitability.'
        },
        {
          p: '<span class="bullet"></span><strong>Part 2: Double-Blind Treatment Phase</strong> – if eligible, you will take two tablets twice a day for 52 weeks.'
        },
        {
          p: '<span class="bullet"></span><strong>Part 3: Open-Label Treatment Phase</strong> – you will take two tablets twice a day for an additional 52 weeks.'
        },
        {
          p: 'After completing the study, you may be able to join the TauRx <strong>Expanded Access Program</strong>, during which only the investigational drug will be provided to participants. Your study doctor will provide further details.'
        },
