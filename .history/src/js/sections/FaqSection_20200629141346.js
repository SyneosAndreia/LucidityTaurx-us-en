...
const FAQ_DATA = {
  expanses: [
    {
      question: 'Why should someone join a clinical research study?',
      answer: [
        {
          p: 'Some of the reasons to join a clinical research study include:'
        },
        {
          p: '<strong>Access to potential future therapies</strong> – you will receive investigational drugs that would otherwise be unavailable to the general public. There will be no charge for any study-related treatment.'
        },
        {
